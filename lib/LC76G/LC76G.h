...
// Startup modes
#define LC76G_HOT_START       "$PMTK101"
#define LC76G_WARM_START      "$PMTK102"
#define LC76G_COLD_START      "$PMTK103"
#define LC76G_FULL_COLD_START "$PMTK104"

#define LC76G_CONFIG_CLEAR  "$PAIR007*3D"
